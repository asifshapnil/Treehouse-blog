...
<?php while($row = $result->fetch_assoc()) {?>
  ...
  <div class="col-lg-4 post">
    <a href = "userspost.php?id=<?php echo $row['uid'];?>">
<center>
<div class="col-md-12">
<div class=" user">
  <img src="<?php echo $row['image'];?>" alt="" width="100%" class="user"> <br>
</div>
<div class="alert alert-warning">
     <?php echo $row['uname']; ?> <br>
</div>
<a href="users.php?aid=<?php echo $row['uid'];?>&uname=<?php echo $row['uname'];?>" class="btn btn-sm btn-block btn-primary">Make Admin</a>
<a href="users.php?did=<?php echo $row['uid'];?>" class="btn btn-sm btn-block btn-danger">Bann User</a>
</div>
</center>
 </a>
  </div>
...
<?php  echo "<li class=".'page-item'."><a class=".'page-link'." href='users.php?page=1'>".'1'."</a></li>";
for ($i=2; $i < $total_page ; $i++) {
  echo "  <li class=".'page-item'."><a class=".'page-link'." href='users.php?page=".$i."'>".$i."</a></li>";
}

echo "<li class=".'page-item'."><a class=".'page-link'." href='users.php?page=".$total_page."'>".$total_page."</a></span></li>";  ?>
<li class="page-item">
